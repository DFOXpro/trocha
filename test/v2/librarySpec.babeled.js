...
(function () {
  ...
  describe('Trocha JS Routes List engine', function () {
    describe('Constants returns', function () {
      ...
      it('should return routes types', function () {
    ...
    describe('Route creation', function () {
      ...
      it('should create routes via post init s function', function () {
        var r;
        r = new Trocha();
      ...
      describe('Route creation params', function () {
        ...
        it('should create routes with hiden parent id', function () {
          ...
          assert.equal(r.simple_id_route.without_parent_id.path(), '/simple_id_route/without_parent_id');
        });
        ...
        it('should create routes with hiden parents id and child id', function () {
          ...
          assert.equal(r.simple_id_route.hide_parent_id.path(), '/simple_id_route/hide_parent_id/:child_id');
          assert.equal(r.simple_id_route.id_2.hide_parents_id.path(), '/simple_id_route/id_2/hide_parents_id');
          assert.equal(r.simple_id_route.hide_parent_id.path({
            simple_id: 'asd'
          }), '/simple_id_route/asd/hide_parent_id/:child_id');
          assert.equal(r.simple_id_route.id_2.hide_parents_id.path({
            child_id: 'asd'
          }), '/simple_id_route/id_2/asd/hide_parents_id');
          assert.equal(r.simple_id_route.id_2.hide_glitch.l.path(), '/simple_id_route/id_2/:child_id/hide_glitch/:$hide/l');
        });
        it('should create routes with prefix', function () {
          ...
          assert.equal(r.simple_route_pre.path({
            pre: true
        ...
        it('should create routes with postfix', function () {
          var r;
          r = new Trocha({
            post: '.the_post',
            alwaysPost: true,
          ...
          assert.equal(r.simple_route_post.path({
            post: true
    ...
    describe('Route types', function () {
      it('should create a route(type route)', function () {
        ...
        assert.equal(r.The.quick.brown.fox.jumps.over.the.lazy.dog.path(), '/The/quick/brown/fox/jumps/over/the/lazy/dog');
        assert.equal(r.The.quick.brown.fox.jumps.over.the.lazy.dog.$as, 'The_quick_brown_fox_jumps_over_the_lazy_dog');
      ...
      it('should create an alias(route type alias)', function () {
        ...
        assert.equal(r.simple_alias_with_method.path(), 'the.simple.alias/with?method');
        assert.equal(r.simple_alias_with_method.$method, 'POST');
        assert.equal(r.The.quick.brown.fox.jumps.over.the.lazy.dog.path(), '/The/quick/brown/fox/jumps/over/the/lazy/cat');
        assert.equal(r.The.quick.brown.fox.jumps.over.the.lazy.dog.$as, 'The_quick_brown_fox_jumps_over_the_lazy_dog');
        ...
        assert.equal(r.The.quick.brown.fox.jumps.over.the.lazy.cat.path(), '/The/quick/brown/fox/jumps/over/the/lazy/tigger');
